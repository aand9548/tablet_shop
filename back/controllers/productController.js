    ...
    try {
        productForm.parse(req, async (err, fields, files) => {
            try {
                ...
                const { productId, productName, productPrice, productModel, productSize,  productResolution, productVolume, productBattery, oldCloudinaryPublicId, oldImagePath } = fields;
